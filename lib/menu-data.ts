/* ════════════════════════════════════════════════════════
   ...
   · AM  = "MENU AM TJW JUN 26"        (breakfast/brunch, 08:00–15:00)
...
export const AM_FOOD: MenuCategory[] = [
    ...
    items: [
      {
        ...
        extra: "Pick your protein: egg (2) +$30 · chicken +$50 · slow-cooked picaña barbacoa +$130",
      ...
      },
      {
        ...
        descEs: "Enchiladas suizas gratinadas con queso manchego. Elige tu proteína: pollo, vegetales o huevo.",
      },
      {
        name: "Eggs Your Way",
        price: "$160",
        ...
        extra: "Extra avocado +$30",
        extraEs: "Extra aguacate +$30",
      },
      {
        name: "Eggs Divorciados",
        price: "$150",
        desc: "Two sunny-side-up eggs on a crunchy tortilla, topped with red and green sauce. Served with beans.",
        descEs: "Dos huevos estrellados montados en tortilla crunchy, bañados en salsa roja y verde. Acompañados con frijolitos.",
      },
      {
        ...
        descEs: "Dos huevos estrellados sobre tortilla crunchy y frijol, bañados en salsa roja casera con queso fresco espolvoreado. Acompañados con frijolitos.",
      },
    ],
  },
  {
    id: "tacos",
    label: "Los Señores Tacos",
    labelEs: "Los Señores Tacos",
    emoji: "🌮",
    items: [
      {
        name: "Los Señores Tacos — Land",
        price: "$230",
        desc: "Wood-fired picanha barbacoa, slow-cooked for 6 hours, served on handmade blue corn tortillas. (3 pieces)",
        descEs: "De la tierra: barbacoa de picaña sellada a la leña, cocida a fuego lento por 6 horas, servida en tortillas de maíz azul hechas a mano. (3 piezas)",
        badge: "signature",
      },
      {
  ...
  },
  {
    ...
    labelEs: "Sandwich & Toast",
    emoji: "🍞",
    items: [
      {
        name: "Avocado Toast",
        price: "$180",
        desc: "Homemade bread topped with avocado, arugula, cherry tomatoes, and a poached egg.",
        descEs: "Pan casero con aguacate, arúgula, tomate cherry y huevo poché.",
        badge: "fanFav",
      },
      {
        name: "Chicken Crispy",
        price: "$200",
        desc: "Homemade bread stuffed with crispy chicken, bacon, cheddar cheese, and house dressing.",
        descEs: "Pan casero, relleno de pollo crispy, tocino, queso cheddar y aderezo de la casa.",
      },
      {
        name: "Barba Sandwich",
        price: "$220",
      ...
      },
      {
        ...
        price: "$180",
        desc: "Homemade bread with manchego cheese, turkey ham, greens mix, avocado, tomato, and onion.",
        descEs: "Pan casero, queso manchego, jamón de pavo, mix de verdes, aguacate, tomate y cebolla.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        name: "Açaí Mi Amor",
        /* EN card (JUN 26) says $140, ES card says $160 — using the updated
           ES price; flagged for client confirmation in docs/INTEGRATIONS.md */
        price: "$160",
      ...
      {
        name: "Fresh & Crunchy",
        /* EN card says $130, ES card says $140 — see note above */
        price: "$140",
